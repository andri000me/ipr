<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <strong>Laporan Buku Tamu</strong>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <!-- <h3 class="box-title">
                    <a href="<?php echo base_url(); ?>admin/tambah_buku_tamu" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-plus fa-fw"></i> Tambah</a>
                    ...
                    <tbody>
                      ...
                      <td align="center">
                          <div class="btn-group" role="group">
                            ...
                            <p>
                            <a href="#" class="btn btn-sm btn-primary btn-flat">Lihat&nbsp;<i class="fa fa-eye"></i></a>
